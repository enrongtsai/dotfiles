...
if s:style ==# 'shusia'
    let s:foreground = [ '#ccc7c4', 250 ]
    let s:background = [ '#2d2a2e', 235 ]
    let s:background_alt = [ '#373332', 236 ]
    let s:background_grey = [ '#494442', 238 ]
    let s:red = [ '#b19689', 203 ]
    let s:yellow = [ '#ecd477', 179 ]
    let s:green = [ '#94b4a5', 107 ]
    let s:blue = [ '#86a2c2', 110 ]
    let s:purple = [ '#adaece', 176 ]
...
elseif s:style ==# 'atlantis'
    ...
    let s:red = [ '#a97d85', 203 ]
    let s:yellow = [ '#b19689', 179 ]
    let s:green = [ '#94b4a5', 107 ]
    let s:blue = [ '#86a2c2', 110 ]
    let s:purple = [ '#adaece', 176 ]
elseif s:style ==# 'maia'
