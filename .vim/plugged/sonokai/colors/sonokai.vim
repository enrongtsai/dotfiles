...
elseif s:configuration.style ==# 'atlantis'
  let s:palette = {
        \ 'black':      ['#181a1c',   '237',  'DarkGrey'],
        \ 'bg0':        ['#252a32',   '235',  'Black'],
        \ 'bg1':        ['#303541',   '236',  'DarkGrey'],
        \ 'bg2':        ['#373c4b',   '236',  'DarkGrey'],
        \ 'bg3':        ['#c07547',   '237',  'Search_HighlightOrange'],
        \ 'bg4':        ['#424b5b',   '237',  'Grey'],
        \ 'bg_red':     ['#ff6d7e',   '203',  'Red'],
        \ 'diff_red':   ['#473536',   '52',   'DarkRed'],
        \ 'bg_green':   ['#86a7a5',   '107',  'Green'],
        \ 'diff_green': ['#384034',   '22',   'DarkGreen'],
        \ 'bg_blue':    ['#7ad5f1',   '110',  'Blue'],
        \ 'diff_blue':  ['#323e47',   '17',   'DarkBlue'],
        \ 'bg_wildmenu':['#4d6a68',   '107',  'DarkGreen'],
        \ 'fg':         ['#c4cad4',   '250',  'White'],
        \ 'red':        ['#ff6578',   '203',  'Red'],
        \ 'orange':     ['#f69c5e',   '215',  'Orange'],
        \ 'yellow':     ['#dabd62',   '179',  'Yellow'],
        \ 'green':      ['#9fc482',   '107',  'Green'],
        \ 'blue':       ['#70b5ce',   '110',  'Blue'],
        \ 'lightblue':  ['#44bfb7',   '110',  'Blue'],
...
call s:HL('Search', s:palette.black, s:palette.bg3)
...
call s:HL('StatusLine', s:palette.fg, s:palette.bg_wildmenu)
...
if s:configuration.enable_italic
  ...
  call s:HL('BlueItalic', s:palette.lightblue, s:palette.none, 'italic')
  call s:HL('OrangeItalic', s:palette.orange, s:palette.none, 'italic')
else
  call s:HL('RedItalic', s:palette.red, s:palette.none)
  call s:HL('BlueItalic', s:palette.lightblue, s:palette.none)
...
highlight! link pythonExceptions Green
highlight! link pythonDecoratorName OrangeItalic
" }}}
" python-syntax: https://github.com/vim-python/python-syntax{{{
highlight! link pythonStatement BlueItalic
